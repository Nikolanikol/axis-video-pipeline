...
// это возможно потому, что оформление в ReviewShort лежит отдельными слоями поверх съёмки.
// Цвет исходника (перевод HDR в BT.709) — не отсюда, он делается при сборке рабочей копии.
