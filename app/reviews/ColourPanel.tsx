...
// Настройки едут на сервер обычным сохранением формы и оттуда попадают в рендер.
// Если правил updateReview — перезапусти сервер: иначе поле теряется молча, и получается
// «в превью цвет есть, в готовом ролике нет» (превью считается здесь, в браузере).
